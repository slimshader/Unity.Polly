...
namespace Polly
{
    public partial class Policy
    {
        ...
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(int seconds)
        {
            ...
            Func<Context, TimeSpan, UniTask, Exception, UniTask> doNothingAsync = (_, _, _, _) => UniTask.FromResult(default(TResult));
        ...
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(int seconds, Func<Context, TimeSpan, UniTask, UniTask> onTimeoutAsync)
        {
            TimeoutValidator.ValidateSecondsTimeout(seconds);
        ...
        /// <exception cref="ArgumentOutOfRangeException">seconds;Value must be greater than zero.</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(int seconds, Func<Context, TimeSpan, UniTask, Exception, UniTask> onTimeoutAsync)
        {
        ...
        /// <exception cref="ArgumentOutOfRangeException">seconds;Value must be greater than zero.</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(int seconds, TimeoutStrategy timeoutStrategy, Func<Context, TimeSpan, UniTask, UniTask> onTimeoutAsync)
        {
            TimeoutValidator.ValidateSecondsTimeout(seconds);
        ...
        /// <exception cref="ArgumentOutOfRangeException">seconds;Value must be greater than zero.</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(int seconds, TimeoutStrategy timeoutStrategy, Func<Context, TimeSpan, UniTask, Exception, UniTask> onTimeoutAsync)
        {
            if (seconds <= 0) throw new ArgumentOutOfRangeException(nameof(seconds));
        ...
        /// <exception cref="ArgumentOutOfRangeException">timeout;Value must be a positive TimeSpan (or Timeout.InfiniteTimeSpan to indicate no timeout)</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(TimeSpan timeout, Func<Context, TimeSpan, UniTask, UniTask> onTimeoutAsync)
        {
            TimeoutValidator.ValidateTimeSpanTimeout(timeout);
        ...
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(TimeSpan timeout, Func<Context, TimeSpan, UniTask, Exception, UniTask> onTimeoutAsync)
        {
        ...
        /// <exception cref="ArgumentOutOfRangeException">timeout;Value must be a positive TimeSpan (or Timeout.InfiniteTimeSpan to indicate no timeout)</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(TimeSpan timeout, TimeoutStrategy timeoutStrategy, Func<Context, TimeSpan, UniTask, UniTask> onTimeoutAsync)
        {
            TimeoutValidator.ValidateTimeSpanTimeout(timeout);
        ...
        /// <exception cref="ArgumentOutOfRangeException">timeout;Value must be greater than zero.</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(TimeSpan timeout, TimeoutStrategy timeoutStrategy, Func<Context, TimeSpan, UniTask, Exception, UniTask> onTimeoutAsync)
        {
            if (timeout <= TimeSpan.Zero) throw new ArgumentOutOfRangeException(nameof(timeout));
        ...
        /// <exception cref="ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(Func<TimeSpan> timeoutProvider, Func<Context, TimeSpan, UniTask, UniTask> onTimeoutAsync)
        {
            if (timeoutProvider == null) throw new ArgumentNullException(nameof(timeoutProvider));
        ...
        /// <exception cref="ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(Func<TimeSpan> timeoutProvider, Func<Context, TimeSpan, UniTask, Exception, UniTask> onTimeoutAsync)
        {
            if (timeoutProvider == null) throw new ArgumentNullException(nameof(timeoutProvider));
        ...
        /// <exception cref="ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(Func<TimeSpan> timeoutProvider, TimeoutStrategy timeoutStrategy, Func<Context, TimeSpan, UniTask, UniTask> onTimeoutAsync)
        {
            if (timeoutProvider == null) throw new ArgumentNullException(nameof(timeoutProvider));
        ...
        /// <exception cref="ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(Func<TimeSpan> timeoutProvider, TimeoutStrategy timeoutStrategy, Func<Context, TimeSpan, UniTask, Exception, UniTask> onTimeoutAsync)
        {
            if (timeoutProvider == null) throw new ArgumentNullException(nameof(timeoutProvider));
        ...
        /// <exception cref="ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(Func<Context, TimeSpan> timeoutProvider, Func<Context, TimeSpan, UniTask, UniTask> onTimeoutAsync)
        ...
        /// <exception cref="ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(Func<Context, TimeSpan> timeoutProvider, Func<Context, TimeSpan, UniTask, Exception, UniTask> onTimeoutAsync)
            => TimeoutAsync<TResult>(timeoutProvider, TimeoutStrategy.Optimistic, onTimeoutAsync);
        ...
        /// <exception cref="ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(Func<Context, TimeSpan> timeoutProvider, TimeoutStrategy timeoutStrategy, Func<Context, TimeSpan, UniTask, UniTask> onTimeoutAsync)
        {
            if (onTimeoutAsync == null) throw new ArgumentNullException(nameof(onTimeoutAsync));
        ...
        /// <exception cref="ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="ArgumentNullException">onTimeoutAsync</exception>
        public static AsyncTimeoutPolicy<TResult> TimeoutAsync<TResult>(Func<Context, TimeSpan> timeoutProvider, TimeoutStrategy timeoutStrategy, Func<Context, TimeSpan, UniTask, Exception, UniTask> onTimeoutAsync)
        {
            if (timeoutProvider == null) throw new ArgumentNullException(nameof(timeoutProvider));
            if (onTimeoutAsync == null) throw new ArgumentNullException(nameof(onTimeoutAsync));
